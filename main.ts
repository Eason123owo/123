...
sprites.onDestroyed(SpriteKind.E3, function (sprite) {
    ...
    k3 = sprites.create(img`
        ...
        . . . . f f f f f f f f f . . . 
        `, SpriteKind.Food)
    k3.setPosition(132, 41)
    game.showLongText("茉莉:把碎片合起來吧", DialogLayout.Bottom)
    k1.destroy()
    k2.destroy()
    k3.destroy()
    pause(1000)
    K = sprites.create(img`
        ...
        . . . . f f f f f f f f f . . . 
        `, SpriteKind.Food)
    game.showLongText("茉莉:完成!", DialogLayout.Bottom)
    K.destroy()
    p1.destroy()
    scene.setBackgroundImage(img`
    ...
    game.splash("比剛剛的Ca王還更粗壯")
    ms5 = sprites.create(assets.image`11`, SpriteKind.E4)
    ms5.setPosition(124, 95)
    game.splash("「人類」")
    ms5.destroy()
    ms5 = sprites.create(assets.image`11`, SpriteKind.E4)
    ms5.setPosition(124, 62)
    p1 = sprites.create(img`
        ...
        `, SpriteKind.Player)
    p1.setPosition(16, 64)
    game.showLongText("茉莉：「欸不是..", DialogLayout.Bottom)
    game.showLongText("是不是哪裡搞錯了?」", DialogLayout.Bottom)
    game.showLongText("史萊姆王：$*-？、！", DialogLayout.Bottom)
    game.showLongText("茉莉：What？", DialogLayout.Bottom)
    game.showLongText("史萊姆王：$@.。！", DialogLayout.Bottom)
    game.showLongText("茉莉：講人話拜託", DialogLayout.Bottom)
    game.showLongText("史萊姆王：#%*&#？", DialogLayout.Bottom)
    game.showLongText("（看起來他對於我們", DialogLayout.Bottom)
    game.showLongText("聽不懂而感到生氣）", DialogLayout.Bottom)
    game.showLongText("茉莉：怕講話卡其哪啊？", DialogLayout.Bottom)
    game.showLongText("算了打倒你就對了", DialogLayout.Bottom)
    p1.destroy()
    p1 = sprites.create(img`
        ................................................
        ...................fffffffffff..................
    ...
    if (controller.B.isPressed()) {
        game.showLongText("茉莉使用香蕉皮", DialogLayout.Bottom)
        game.showLongText("史萊姆王滑倒", DialogLayout.Bottom)
        game.showLongText("史萊姆王使用文字亂碼", DialogLayout.Bottom)
        game.showLongText("茉莉問號", DialogLayout.Bottom)
        game.showLongText("最後一擊茉莉使用帽子", DialogLayout.Bottom)
        game.showLongText("史萊姆王爆炸", DialogLayout.Bottom)
        ms5.destroy()
        p1.destroy()
        p1 = sprites.create(img`
            ................................................
            ...
            `, SpriteKind.Player)
        p1.setPosition(16, 64)
        game.showLongText("史萊姆王：掰...掰..", DialogLayout.Bottom)
        game.showLongText("茉莉：...算了", DialogLayout.Bottom)
        game.showLongText("starts戰利品", DialogLayout.Bottom)
        game.showLongText("open模式", DialogLayout.Bottom)
        game.showLongText("(記得要大聲喊)", DialogLayout.Bottom)
        game.splash("茉莉打開寶藏")
        game.showLongText("茉莉：什.....什麼！", DialogLayout.Bottom)
        game.showLongText("是續集！", DialogLayout.Bottom)
        game.splash("本篇以完全結束")
        game.splash("敬請期待下一個作品")
        game.splash("感謝各位的遊玩")
        game.over(true, effects.confetti)
    } else {
        game.showLongText("史萊姆王:哈哈", DialogLayout.Bottom)
        game.showLongText("你已死亡", DialogLayout.Bottom)
        game.showLongText("請重新遊玩", DialogLayout.Bottom)
        game.reset()
    }
})
sprites.onDestroyed(SpriteKind.E2, function (sprite) {
    ...
    p1 = sprites.create(img`
        ...
        `, SpriteKind.Player)
    p1.setPosition(16, 64)
    game.showLongText("茉莉:又被順移了", DialogLayout.Bottom)
    game.showLongText("這次又是...甚麼呢?", DialogLayout.Bottom)
    game.showLongText("通過香蕉狗問題的茉莉", DialogLayout.Bottom)
    game.showLongText("正前往氣場沉重的Ca王領地", DialogLayout.Bottom)
    game.showLongText("茉莉:這裡的氣場好沉重", DialogLayout.Bottom)
    game.showLongText("Ca王：你是...人類！？", DialogLayout.Bottom)
    game.showLongText("茉莉:原來如此！", DialogLayout.Bottom)
    game.showLongText("難怪打球會爛", DialogLayout.Bottom)
    game.showLongText("是因為4隻手會纏在一起吧", DialogLayout.Bottom)
    game.showLongText("Ca王：是香蕉狗告訴你的？", DialogLayout.Bottom)
    game.showLongText("嗐...那傢伙", DialogLayout.Bottom)
    game.showLongText("老是愛跟別人裝熟", DialogLayout.Bottom)
    game.showLongText("勸你離題遠點", DialogLayout.Bottom)
    game.showLongText("他個性其實很糟糕", DialogLayout.Bottom)
    game.showLongText("茉莉:我是來取得碎片的", DialogLayout.Bottom)
    game.showLongText("Ca王：好久沒遇到人類了", DialogLayout.Bottom)
    game.showLongText("來比試一下贏了就給你", DialogLayout.Bottom)
    p1.destroy()
    p1 = sprites.create(img`
        ................................................
        ...................fffffffffff..................
    ...
    p1.setPosition(16, 64)
    game.splash("請選擇攻擊武器")
    mySprite.say(game.ask("a雷電鐵絲 b帽子"))
    if (controller.A.isPressed()) {
        game.showLongText("茉莉使用帽子", DialogLayout.Bottom)
        game.showLongText("Ca王迴避", DialogLayout.Bottom)
        game.showLongText("茉莉受傷", DialogLayout.Bottom)
        game.showLongText("Ca王使用赤手空拳", DialogLayout.Bottom)
        game.showLongText("茉莉受傷", DialogLayout.Bottom)
        game.showLongText("Ca王使用大招", DialogLayout.Bottom)
        game.showLongText("(五馬分屍)", DialogLayout.Bottom)
        game.showLongText("茉莉使用香蕉皮", DialogLayout.Bottom)
        game.showLongText("Ca王滑倒", DialogLayout.Bottom)
        game.showLongText("Ca王再次使用大招", DialogLayout.Bottom)
        game.showLongText("茉莉使用雷電鐵絲", DialogLayout.Bottom)
        game.showLongText("困住Ca王並電擊", DialogLayout.Bottom)
        game.showLongText("Ca王電倒", DialogLayout.Bottom)
        game.showLongText("Ca王：啊...你....", DialogLayout.Bottom)
        game.showLongText("碎片...", DialogLayout.Bottom)
        game.showLongText("給你吧...", DialogLayout.Bottom)
        game.showLongText("(昏倒)", DialogLayout.Bottom)
        game.showLongText("茉莉：終於...", DialogLayout.Bottom)
        game.showLongText("碎片總算湊齊了", DialogLayout.Bottom)
        k3 = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            ...
            . . . . f f f f f f f f f . . . 
            `, SpriteKind.Food)
        k3.setPosition(82, 35)
        game.showLongText("（遺跡碎片*1）", DialogLayout.Bottom)
        k3.destroy()
        ms4.destroy()
    } else {
        game.showLongText("Ca王:別忘了", DialogLayout.Bottom)
        game.showLongText("我可是骨頭呢", DialogLayout.Bottom)
        game.showLongText("根本沒傷害", DialogLayout.Bottom)
        game.showLongText("你已死亡", DialogLayout.Bottom)
        game.showLongText("請重新遊玩", DialogLayout.Bottom)
        game.reset()
    }
})
sprites.onDestroyed(SpriteKind.E1, function (sprite) {
    scene.setBackgroundImage(img`
    ...
    mySprite3 = sprites.create(img`
        ...
        .........ffffff.................................
        `, SpriteKind.E2)
    mySprite3.setPosition(133, 56)
    mySprite.destroy()
    p1.destroy()
    pause(1000)
    game.showLongText("...", DialogLayout.Bottom)
    game.splash("終於有人類來了")
    game.showLongText("香蕉狗(像香蕉的狗狗", DialogLayout.Bottom)
    game.showLongText("無技能但喜歡猜謎)", DialogLayout.Bottom)
    p1 = sprites.create(img`
        ................................................
        ...................fffffffffff..................
        ..................fbbbbbbbbbbff.................
        ...
        `, SpriteKind.Player)
    p1.setPosition(16, 64)
    game.showLongText("茉莉:啊啊啊...", DialogLayout.Bottom)
    game.showLongText("這又是哪裡了", DialogLayout.Bottom)
    game.showLongText("打倒磷化H的茉莉", DialogLayout.Bottom)
    game.showLongText("被不明力量順移到", DialogLayout.Bottom)
    game.showLongText("愛裝熟的香蕉狗地盤", DialogLayout.Bottom)
    game.showLongText("茉莉:好多像香蕉的植物喔", DialogLayout.Bottom)
    game.showLongText("香蕉狗：汪汪！嘿！兄弟～", DialogLayout.Bottom)
    game.showLongText("歡迎來到第二關", DialogLayout.Bottom)
    game.showLongText("茉莉：我跟你很熟嗎...", DialogLayout.Bottom)
    game.showLongText("你是碎片的守衛吧", DialogLayout.Bottom)
    game.showLongText("香蕉狗：哼哼", DialogLayout.Bottom)
    game.showLongText("看來你直覺挺敏銳的", DialogLayout.Bottom)
    game.showLongText("想要在我這裡拿到碎片", DialogLayout.Bottom)
    game.showLongText("必須回答我一個問題！", DialogLayout.Bottom)
    game.showLongText("茉莉：我都不知到要考試！", DialogLayout.Bottom)
    game.showLongText("我又沒有念書！ ", DialogLayout.Bottom)
    game.showLongText("香蕉狗：什麼東西有長有短", DialogLayout.Bottom)
    game.showLongText("且有黃有綠", DialogLayout.Bottom)
    game.showLongText("還能幫助你們人類瘦下來！", DialogLayout.Bottom)
    game.showLongText("茉莉：呃…", DialogLayout.Bottom)
    game.showLongText("香蕉....嗎？", DialogLayout.Bottom)
    game.showLongText("香蕉狗：你..你怎麼知道", DialogLayout.Bottom)
    game.showLongText("茉莉：呃...", DialogLayout.Bottom)
    k2 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
    ...
    game.showLongText("（遺跡碎片*1）", DialogLayout.Bottom)
    k2.destroy()
    game.showLongText("香蕉狗：算了~", DialogLayout.Bottom)
    game.showLongText("看你這麼聰明", DialogLayout.Bottom)
    game.showLongText("偷偷告訴你一件事", DialogLayout.Bottom)
    game.showLongText("你去的下一站的守護者", DialogLayout.Bottom)
    game.showLongText("他打球超爛的", DialogLayout.Bottom)
    game.showLongText("茉莉:欸不是！", DialogLayout.Bottom)
    game.showLongText("告訴我這幹嘛！", DialogLayout.Bottom)
    game.showLongText("而且外星人竟然會打球喔！", DialogLayout.Bottom)
    mySprite3.destroy()
})
...
scene.setBackgroundImage(img`
    ...
    `)
pause(2000)
game.showLongText("近幾年來每當到了凌晨", DialogLayout.Bottom)
game.showLongText("森林裡出現超自然現象", DialogLayout.Bottom)
game.showLongText("通向外星人所在地的傳送門", DialogLayout.Bottom)
game.showLongText("探險家得知此消息後", DialogLayout.Bottom)
game.showLongText("去尋找從未找的外星人寶藏", DialogLayout.Bottom)
game.showLongText("根據幾百年前發現的寶藏圖", DialogLayout.Bottom)
game.showLongText("敘述必須湊齊鑰匙碎片", DialogLayout.Bottom)
game.showLongText("就能打開遺跡的大門", DialogLayout.Bottom)
scene.setBackgroundImage(img`
    
...
mySprite.setPosition(1, 94)
mySprite.setVelocity(31, 0)
game.onUpdate(function () {
    if (mySprite.x >= 100) {
        ...
        mySprite.setPosition(3, 96)
        mySprite.destroy()
        game.showLongText("莫莉(本篇主角)", DialogLayout.Bottom)
        game.showLongText("緩慢地走進傳送門", DialogLayout.Bottom)
        game.showLongText("等待他的是一堆奇異的植物", DialogLayout.Bottom)
        game.showLongText("有的還長滿眼睛直視著她", DialogLayout.Bottom)
        p1 = sprites.create(img`
            ................................................
            ...................fffffffffff..................
            ..................fbbbbbbbbbbff.................
            ...
            `, SpriteKind.Player)
        p1.setPosition(16, 64)
        game.showLongText("莫莉：酷ㄟ!這什麼地方啊?", DialogLayout.Bottom)
        game.showLongText("據說每個地方都有守護者", DialogLayout.Bottom)
        game.showLongText("守護者身上都有者碎片", DialogLayout.Bottom)
        game.showLongText("只有...啊啊啊!有怪物!", DialogLayout.Bottom)
        p1.destroy()
        p1 = sprites.create(img`
            ................................................
            ...................fffffffffff..................
            ...
            `, SpriteKind.Player)
        p1.setPosition(16, 64)
        game.showLongText("磷化H(很像氣體", DialogLayout.Bottom)
        game.showLongText("會順移但...", DialogLayout.Bottom)
        game.showLongText("每24小時只能一次)", DialogLayout.Bottom)
        scene.setBackgroundImage(img`
            ...
            1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
            `)
        game.showLongText("茉莉:...發身什麼事!?", DialogLayout.Bottom)
        game.showLongText("系統已上線", DialogLayout.Bottom)
        game.showLongText("系統:只要遇到外星人", DialogLayout.Bottom)
        game.showLongText("就...變白..", DialogLayout.Bottom)
        game.showLongText("自...小..心", DialogLayout.Bottom)
        game.showLongText("系統已下線", DialogLayout.Bottom)
        mySprite2 = sprites.create(img`
            ...
            ................................................
            `, SpriteKind.E1)
        mySprite2.setPosition(146, 64)
        game.showLongText("磷化H:你..說誰是怪物?", DialogLayout.Bottom)
        game.showLongText("豈有此理!膽敢踏入此地", DialogLayout.Bottom)
        game.showLongText("還說我是怪物!!", DialogLayout.Bottom)
        game.showLongText("別想活著回去！", DialogLayout.Bottom)
        game.showLongText("戰鬥  開始", DialogLayout.Center)
        game.showLongText("解說:此為回合篇選擇制戰鬥", DialogLayout.Bottom)
        game.showLongText("選擇以下兩種武器", DialogLayout.Bottom)
        game.showLongText("武器可能與劇情無關", DialogLayout.Bottom)
        game.showLongText("請勿大驚小怪", DialogLayout.Bottom)
        game.showLongText("能克制外星人則直接死亡", DialogLayout.Bottom)
        game.showLongText("無則無法造成傷害", DialogLayout.Bottom)
        game.showLongText("選擇出現", DialogLayout.Bottom)
        game.showLongText("請只選擇a或b", DialogLayout.Bottom)
        game.showLongText("謝謝配合", DialogLayout.Bottom)
        game.showLongText("解說完畢", DialogLayout.Bottom)
        game.splash("請選擇攻擊武器")
        mySprite.say(game.ask("a螢光劍 b弓箭"))
        if (controller.A.isPressed()) {
            game.showLongText("磷化H使用衝擊", DialogLayout.Bottom)
            game.showLongText("茉莉被撞倒", DialogLayout.Bottom)
            game.showLongText("茉莉使用香蕉皮", DialogLayout.Bottom)
            game.showLongText("磷化H無效", DialogLayout.Bottom)
            game.showLongText("磷化H使用雷射光", DialogLayout.Bottom)
            game.showLongText("手滑照到自己", DialogLayout.Bottom)
            game.showLongText("茉莉受傷", DialogLayout.Bottom)
            game.showLongText("磷化H使用大招", DialogLayout.Bottom)
            game.showLongText("(死亡雷射光)", DialogLayout.Bottom)
            game.showLongText("茉莉使用螢光劍", DialogLayout.Bottom)
            game.showLongText("反射力量", DialogLayout.Bottom)
            game.showLongText("磷化H死亡", DialogLayout.Bottom)
            game.showLongText("磷化H可..可惡..啊", DialogLayout.Bottom)
            k1 = sprites.create(img`
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                . . . . . f f f f f f f . . . . 
                ...
                . . . . . . . . . . . . . . . . 
                `, SpriteKind.Food)
            k1.setPosition(82, 35)
            game.showLongText("(獲得碎片)", DialogLayout.Bottom)
            k1.destroy()
            mySprite2.destroy()
        } else {
            game.showLongText("磷化H根本不痛不癢", DialogLayout.Bottom)
            game.showLongText("你已死亡", DialogLayout.Bottom)
            game.showLongText("請重新遊玩", DialogLayout.Bottom)
            game.reset()
        }
